...
// Imports simplifiés pour l'instant
...
class OnboardingViewModel(
    ...
    // Listes simplifiées pour l'instant (à remplacer par les vraies ressources)
    private val relationshipGoalsText: List<String> = listOf(
        "Créer une connexion",
        "Parler des sujets évités", 
        "Augmenter la passion",
        "Partager plus de rires",
        "Trouver la complicité"
    )

    private val relationshipImprovementsText: List<String> = listOf(
        "Créer un moment fort",
        "Raviver la connexion", 
        "Casser la routine",
        "Dire l'inavoué"
    )
    ...
    // === Result<T> based operations === (Temporairement commenté)
    /*
