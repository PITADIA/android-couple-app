...
fun CommunicationEvaluationStepScreen(
    ...
    // Options selon le rapport: ["1-4", "4-6", "6-8", "8-10"]
    val ratingOptions = listOf("1-4", "4-6", "6-8", "8-10")
    ...
    Surface(
        ...
        Column(
            ...
            Text(
                text = stringResource(R.string.communication_evaluation_question),
            ...
            OnboardingButtonZone(
                ...
                isContinueEnabled = selectedRating.isNotEmpty()
            )
        }
    }
}